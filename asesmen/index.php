...
$sql = "SELECT r.no_rawat, r.no_reg, r.tgl_registrasi, r.jam_reg, r.stts,
               ...
               (SELECT COUNT(*) FROM penilaian_treatment_wajah WHERE no_rawat = r.no_rawat) as count_kecantikan
        FROM reg_periksa r
...
$judulHalaman = 'Daftar Asesmen Pasien';
$baseAsset    = '../';
...
<div class="card">
    ...
    <p class="text-muted" style="margin-bottom: 15px;">
        Pilih pasien terdaftar di bawah ini untuk langsung mengisi atau melihat dokumen asesmen klinis & SOAP.
    </p>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="indikator-container">
                                ...
                                <!-- Asesmen Kecantikan & Face Massage -->
                                <span class="badge-indicator <?= $r['count_kecantikan'] > 0 ? 'filled' : 'empty' ?>" title="Asesmen Kecantikan & Face Massage">
                                    <?= $r['count_kecantikan'] > 0 ? '✔ Kecantikan' : '✘ Kecantikan' ?>
                                </span>
                            </div>
                        </td>
                        <td>
                            <a href="pilih.php?no_rawat=<?= urlencode($r['no_rawat']) ?>" class="btn btn-primary" style="padding:6px 12px; font-size: 13px; text-decoration: none; display: inline-block;">
                                Pilih
                            </a>
                        </td>
                    </tr>
