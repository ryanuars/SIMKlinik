...
$judulHalaman = 'Pilih Pasien untuk Tindakan';
$baseAsset    = '../';
...
<div class="card">
    <p class="card-title">Daftar Pasien Terdaftar</p>
        Pilih pasien terdaftar di bawah ini untuk menambahkan Tindakan Medis (Dokter, Perawat, atau Bersama).
    </p>
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="input.php?no_rawat=<?= urlencode($r['no_rawat']) ?>" class="btn btn-primary" style="padding:6px 12px; font-size: 13px; text-decoration: none; display: inline-block;">
                                Input Tindakan
                            </a>
                        </td>
                    </tr>
